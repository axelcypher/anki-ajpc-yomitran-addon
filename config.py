...
DEFAULT_SOURCE_FIELDS = [
    ...
    {"name": "VocabFurigana", "label": "Vocab Furigana", "enabled": True},
    {"name": "VocabAudio", "label": "Vocab Audio", "enabled": True},
    {"name": "POS", "label": "POS", "enabled": True},
    {"name": "GlossaryJMDictGerHTML", "label": "Glossary JMDict DE (HTML)", "enabled": True},
    {"name": "GlossaryJitendexEndHTML", "label": "Glossary Jitendex EN (HTML)", "enabled": True},
...
DEFAULT_VIRTUAL_FIELDS = [
    ...
    {"id": "FamilyID", "name": "Family ID (from VocabFurigana)", "type": "copy", "source": "VocabFurigana"},
    {"id": "SourceNoteLink", "name": "Source Note Link", "type": "note_link", "label": "Source"},
    {"id": "Vocab", "name": "Vocab (from VocabFurigana)", "type": "copy", "source": "VocabFurigana"},
]
...
DEFAULT_CATEGORIES = [
    {
        ...
        "name": "Verbs",
        "note_type_id": None,
        "filter": {"source_field": "POS", "values": ["godan", "ichidan", "suru"]},
        "field_map": {},
    },
    {
        "id": "adjective",
        "name": "Adjectives",
        "note_type_id": None,
        "filter": {"source_field": "POS", "values": ["na/i"]},
        "field_map": {},
    },
    {
        "id": "other",
        "name": "Other",
        "note_type_id": None,
        "filter": {"source_field": "POS", "values": []},
        "field_map": {},
    },
]
